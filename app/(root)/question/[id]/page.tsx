...
const page = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <>
        ...
        <div className="flex w-full flex-col-reverse justify-between gap-5 sm:flex-row sm:items-center sm:gap-2">
          ...
          <div className="flex justify-end">
            <Votes
              ...
              userId={mongoUser?._id ? JSON.stringify(mongoUser._id) : undefined}
      ...
      <AllAnswers questionId={result._id} totalAnswers={result.answers.length} userId={mongoUser?._id} />

      {mongoUser && <Answer authorId={JSON.stringify(mongoUser._id)} questionId={JSON.stringify(result._id)} />}
    </>
  );
};
